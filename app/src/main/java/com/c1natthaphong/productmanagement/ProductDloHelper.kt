...
class ProductDloHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun getAllProducts(): List<Product> {
        ...
        with(cursor) {
            while (moveToNext()) {
                ...
                val product = Product(id, name, description, price, quantity, imagePath)
    ...
    fun deleteProduct(id: Int): Int {
        val db = writableDatabase
        // แก้ไข bug: เพิ่ม =? ใน WHERE clause
